...
"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds, Iam Rename Tg Bot King ☮️"
    ...
    SAVED_RECVD_DOC_FILE = "<b>File Downloaded Successfully,So Now Wait Peacefuly For Uploading 😎</b>"
    ...
    IFLONG_FILE_NAME = """You Gotta Be Kidding Me...Decrease The Number Of Letters Or I sAD😔😉"""
    ABOUT_ME = """<b>Meh : \n Iam 𝘼𝙨𝙝 𝙆𝙚𝙩𝙘𝙝𝙪𝙢 An Telegram File Renamer Bot Which Can Rename A Telegram Files. \n You Can Set Permanent Thumbnail For The File So You Don't Have To Send Custom Thumbs All The Time.\n \n i can also convert files into videos \n Feedback @VAMPIRE_KING_NO_1 If You Found Meh Useful</b>"""
    HELP_USER = """Checkout The Available Commands Here \n\n Do Follow @storytimeoG If You Find This Bot Usefull❤️"""
